...
import { LayoutDashboard, Bot, KeyRound, Settings, Layers, Sparkles, Eye, MessageSquare, Menu, X, Plus, ChevronRight, Folder as FolderIcon, Trash2, FolderKanban } from "lucide-react";
...
function NavColumn({ onNavigate }: { onNavigate?: () => void }) {
  ...
  const { profile, folders, projects, addFolder, removeFolder } = useGodEye();
